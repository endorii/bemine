        ...
        <div className="flex flex-col">
            <WrapperContainer className="px-20 py-7 bg-blue-600/20">
                <div className="relative flex items-center w-full">
                    ...
                    <div className="flex">
                        <select
                            className="px-3 py-4 outline-0 bg-white w-[70px]"
                            value={selectedState || ""}
                            onChange={(e) => {
                        ...
                        <select
                            className="px-3 outline-0 bg-white w-[150px] truncate"
                            value={selectedCity || ""}
            ...
            <WrapperContainer className="flex flex-col py-[70px] gap-[50px]">
                ...
                <div className="grid grid-cols-6 gap-y-6 gap-x-1 justify-items-center">
                        ...
                        >
                            ...
                            {openCategory === cat.name && (
                                <div className="mt-2 flex flex-col rounded-md shadow-[0px_0px_6px_0px_rgba(0,_0,_0,_0.1)] w-full text-[14px] text-left">
                                    <Link
                                        href={"#"}
                                        className="flex gap-1 items-end p-3 group hover:bg-blue-50/50 font-semibold py-4"
                                    >
                                    ...
                                    {cat.subcategories.map((sub, idx) => (
                                        <Link
                                            href={"#"}
                                            key={idx}
                                            className="flex gap-1 items-end p-3 group hover:bg-blue-50/50"
                                        >
                                            <ChevronRightIcon className="size-5 group-hover:stroke-blue-600" />
                                            <div className="group-hover:text-blue-600">
                                                {sub}
